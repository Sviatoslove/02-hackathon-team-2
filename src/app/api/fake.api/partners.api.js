...
const partners = [
  {
    ...
    about_me:
      'Начиная с 2022 года, я активно занимаюсь разработкой  сайтов.  Мое стремление и усердие в этой области нацелены на дальнейший рост и желание стать программистом. Кроме работы, я также нахожу время для занятий в тренажерном зале.',
    favorites: false
  },
  {
  ...
  },
  {
    ...
    about_me:
      'Я рад сотрудничать с такими великолепными коллегами, у которых есть такие прекрасные качества. Я уверен, что мы справимся с любой поставленной задачей. Мне хочется принимать участие в новых и интересных проектах и я готов приложить все необходимые усилия для их успешной реализации. Вместе мы сможем достичь великих результатов и при этом не забывать о заслуженном отдыхе и хорошей еде.',
    favorites: false
  }
]
